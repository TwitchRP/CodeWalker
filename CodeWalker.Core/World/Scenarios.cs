...
namespace CodeWalker.World
{
    public class Scenarios
    {
        ...
        public void Init(GameFileCache gameFileCache, Action<string> updateStatus, Timecycle timecycle)
        {
            ...
            "club_la_mesa_warehouse",
            "club_mission_row_building",
            "club_strawberry_warehouse",
            "club_west_vinewood_building",
            "club_cypress_flats_warehouse",
            "club_lsia_warehouse",
            "club_elysian_island_warehouse",
            "club_vinewood_dt",
            "club_vespucci_canals_building",
            "club_del_perro_building",
            "facility_main_3",
            "facility_main_2",
            "facility_main_1",
            "facility_cannon",
            ...
            foreach (var scenarioGroupName in ScenarioGroupNames)
            {
                JenkIndex.Ensure(scenarioGroupName);
            }
